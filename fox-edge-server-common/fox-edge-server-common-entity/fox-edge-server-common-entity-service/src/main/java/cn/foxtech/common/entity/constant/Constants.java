...
public class Constants {
    ...
    public static final String ParamTemplateEntity = "ParamTemplateEntity";
    public static final String DeviceValueEntity = "DeviceValueEntity";
    public static final String DeviceRecordEntity = "DeviceRecordEntity";
    public static final String ObjectInfoEntity = "ObjectInfoEntity";
    public static final String ObjectEntity = "DeviceObjectEntity";
    public static final String ObjectValEntity = "ObjectValEntity";

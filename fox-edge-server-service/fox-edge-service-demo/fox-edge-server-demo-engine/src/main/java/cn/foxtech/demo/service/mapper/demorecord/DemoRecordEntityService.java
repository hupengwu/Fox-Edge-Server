...
package cn.foxtech.demo.service.mapper.demorecord;
...
@Component
public class DemoRecordEntityService extends BaseEntityService {
    ...
    public List<DemoRecordEntity> selectPoListByPage(Map<String, Object> param) {

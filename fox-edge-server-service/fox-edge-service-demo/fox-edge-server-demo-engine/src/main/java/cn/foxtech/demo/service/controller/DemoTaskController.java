...
package cn.foxtech.demo.service.controller;
...
import cn.foxtech.demo.service.service.DemoManageService;
...
public class DemoTaskController {
    ...
    public AjaxResult selectEntityList() {
        List<BaseEntity> entityList = this.entityManageService.getEntityList(DemoTaskEntity.class);
    ...
    public AjaxResult selectEntityListByNameList(@RequestBody Map<String, Object> body) {
        ...
        this.entityManageService.getEntityList(DemoTaskEntity.class, (Object value) -> {
            DemoTaskEntity entity = (DemoTaskEntity) value;
    ...
    private AjaxResult selectEntityList(Map<String, Object> body, boolean isPage) {
        try {
            List<BaseEntity> entityList = this.entityManageService.getEntityList(DemoTaskEntity.class, (Object value) -> {
                DemoTaskEntity entity = (DemoTaskEntity) value;
    ...
    public AjaxResult queryEntity(@QueryParam("name") String name) {
        DemoTaskEntity entity = new DemoTaskEntity();
        entity.setTaskName(name);

        DemoTaskEntity exist = this.entityManageService.getEntity(entity.makeServiceKey(), DemoTaskEntity.class);
        if (exist == null) {
    ...
    private AjaxResult insertOrUpdate(Map<String, Object> params) {
        try {
            ...
            if (params.get("id") == null) {
                ...
                DemoTaskEntity exist = this.entityManageService.getEntity(id, DemoTaskEntity.class);
                if (exist == null) {
                    return AjaxResult.error("实体不存在");
                }
    ...
    public AjaxResult deleteEntityList(@QueryParam("ids") String ids) {
        ...
        for (String id : idList) {
            ...
            this.entityManageService.deleteEntity(Long.parseLong(id), DemoTaskEntity.class);
        }

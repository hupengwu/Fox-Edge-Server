 ...
 */
@Component
public class DefineEntityLocalDataBase {
    /**
     * 实体和数据库表的对应关系
     */
    ...
    public Set<String> getEntityTypeList() {
        Map<String, Map<String, Object>> entityPublishMap = this.entityManageService.getPublishEntityMap(EntityPublishConstant.value_mode_define);

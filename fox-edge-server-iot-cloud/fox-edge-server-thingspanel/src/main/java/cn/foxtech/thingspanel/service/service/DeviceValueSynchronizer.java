...
import cn.foxtech.cloud.common.remote.RemoteHttpProxyService;
...
public class DeviceValueSynchronizer {
    ...
    public void publish(Set<String> serviceKeys, Map<String, Object> redisHashMap) {
        ...
        String resource = "/device/{token}/attributes";
        ...
        for (String serviceKey : serviceKeys) {
            try {
                ...
                // 取出配置的token信息
                String token = (String) extendParam.get("thingspanelHttpToken");

...
public class RemoteService {
    ...
    private Map<String, Object> executePost(String topic, Map<String, Object> body, long timeOut) throws InterruptedException {
        // 补齐uuid
        ...
        // 等待数据返回：
        return (Map<String, Object>) SyncFlagObjectMap.inst().waitDynamic(uuid, timeOut);
    }

    public void publishEntity(String entityType, Map<String, Object> dataList) throws IOException, InterruptedException {
        String topic = this.iotFoxPublishService.getPublish() + "/" + entityType.toLowerCase() + "/rows";
    ...
    public Object queryTimestamp(String entityType, long timeOut) throws ServiceException, InterruptedException {
        String topic = this.iotFoxPublishService.getPublish() + "/" + entityType.toLowerCase() + "/timestamp";
        Map<String, Object> data = new HashMap<>();
        data.put("edgeId", edgeId);
        data.put("entityType", StringUtils.camelName(entityType));
        Map<String, Object> body = new HashMap<>();
        body.put("data", data);
        //   body.put("uuid", "4e07580e1a364b28872411178c7ec437");

        Map<String, Object> respond = this.executePost(topic, body, timeOut);

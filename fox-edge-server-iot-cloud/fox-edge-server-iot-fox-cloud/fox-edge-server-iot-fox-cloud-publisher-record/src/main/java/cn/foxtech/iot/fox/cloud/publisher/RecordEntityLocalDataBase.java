 ...
 */
@Component
public class RecordEntityLocalDataBase {
    /**
     * 实体和数据库表的对应关系
     */
    ...
    public Set<String> getEntityTypeList() {
        Map<String, Map<String, Object>> entityPublishMap = this.entityManageService.getPublishEntityMap(EntityPublishConstant.value_mode_record);
    ...
    /**
     * 查询最近ID：这个操作MySQl非常快，不到1毫秒，MYSQl实际上是缓存中执行的
     *
     * @return 最后一行数据
     */

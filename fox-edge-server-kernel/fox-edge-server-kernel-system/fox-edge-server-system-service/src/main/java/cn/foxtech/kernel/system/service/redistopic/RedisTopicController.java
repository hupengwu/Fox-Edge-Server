package cn.foxtech.kernel.system.service.redistopic;
...
@Component
public class RedisTopicController implements IRedisTopicController {
    ...
    public RestFulRespondVO execute(RestFulRequestVO requestVO) {
        try {
            String resource = this.getResource(requestVO.getUri());
            ...
            if (methodName.equals("POST") || methodName.equals("PUT")) {
                ...
                List<Object> params = this.getParams(requestVO.getUri(), (Method) method);
                if (params.size() == 0) {

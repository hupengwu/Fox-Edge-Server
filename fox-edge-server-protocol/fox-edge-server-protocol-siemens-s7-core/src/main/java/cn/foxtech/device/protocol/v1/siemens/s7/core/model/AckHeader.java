...
import cn.foxtech.device.protocol.v1.siemens.s7.core.enums.EErrorClass;
...
public class AckHeader extends Header {
    ...
    public byte[] toByteArray() {
        return ByteWriteBuff.newInstance(BYTE_LENGTH).putBytes(super.toByteArray()).putByte(errorClass.getCode()).putByte(this.errorCode).getData();
    }
}

...
public class InfObjSyncParamFixEntity extends InfObjEntity {
    /**
     * 系统类型（1 字节）
     */
    ...
    public static void decodeEntity(byte[] data, InfObjSyncParamFixEntity entity) {
    ...
    public static byte[] encodeEntity(InfObjSyncParamFixEntity entity) {

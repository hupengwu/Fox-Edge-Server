...
public class InfObjGetParamRspFixEntity extends InfObjEntity {
    /**
     * 系统类型（1 字节）
     */
    ...
    public static void decodeEntity(byte[] data, InfObjGetParamRspFixEntity entity) {
    ...
    public static byte[] encodeEntity(InfObjGetParamRspFixEntity entity) {

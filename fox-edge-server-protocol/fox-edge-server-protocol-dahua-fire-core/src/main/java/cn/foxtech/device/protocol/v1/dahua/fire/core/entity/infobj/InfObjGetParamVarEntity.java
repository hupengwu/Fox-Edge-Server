...
public class InfObjGetParamVarEntity extends InfObjEntity {
    /**
     * 系统类型（1 字节）
     */
    ...
    public static void decodeEntity(byte[] data, InfObjGetParamVarEntity entity) {
    ...
    public static byte[] encodeEntity(InfObjGetParamVarEntity entity) {

...
public class DigesterProtocolStopWork {
    /**
     * 查询传感器状态
     *
     * @param param 输入参数
     * @return 操作是否成功
     */
    @FoxEdgeOperate(name = "停止设备当前工作", type = FoxEdgeOperate.encoder)
     ...
     * @return 解码是否成功
     */
    @FoxEdgeOperate(name = "停止设备当前工作", type = FoxEdgeOperate.decoder, timeout = 2000)

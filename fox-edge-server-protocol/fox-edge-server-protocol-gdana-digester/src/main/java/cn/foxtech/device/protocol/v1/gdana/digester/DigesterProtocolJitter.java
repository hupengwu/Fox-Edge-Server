...
public class DigesterProtocolJitter {
    /**
     * 查询传感器状态
     *
     * @param param 输入参数
     * @return 操作是否成功
     */
    @FoxEdgeOperate(name = "振动摇匀", type = FoxEdgeOperate.encoder)
     ...
     * @return 解码是否成功
     */
    @FoxEdgeOperate(name = "振动摇匀", type = FoxEdgeOperate.decoder, timeout = 2000)
